  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_List2.default, { tasks: this.state.tasks,
    ...
    value: function addTask() {
      this.setState({
        tasks: [].concat(_toConsumableArray(this.state.tasks), [this.state.input])
      });
    }
  }, {
    key: 'doneTask',
    value: function doneTask(i) {
      var copy = this.state.tasks.slice();
      copy.splice(i, 1);
      this.setState({
        tasks: copy
      });
...
var _Entry = __webpack_require__(31);
...
var List = function List(props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement('input', { onChange: props.onInputChange }),
    ...
    _react2.default.createElement(
      ...
      props.tasks.map(function (task, key) {
        return _react2.default.createElement(_Entry2.default, { index: key, key: key, doneTask: props.doneTask, task: task });
      })
    )
  );
};
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { onClick: function onClick() {
            return props.doneTask(props.index);
          } },
        'Done!'
      )
    )
